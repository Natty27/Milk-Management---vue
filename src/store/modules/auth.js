import { login, register, getAllUsersAPI, getUserByIDAPI, getUserByNameAPI, getCurrentUserAPI } from '../../api/authService';
import { 
  ...
  GET_USER_BY_NAME_REQUEST, GET_USER_BY_NAME_SUCCESS, GET_USER_BY_NAME_FAILURE,
...
const actions = {
  async login({ commit }, credentials) {
    ...
    try {
      const { access_token: token, user } = await login(credentials);
