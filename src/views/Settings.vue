    ...
    <div class="max-w-7xl mx-auto">
      ...
      >
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div v-if="expensePieChartData" class="mt-6">
            <h3 class="text-lg font-medium text-gray-900 mb-3">Category Breakdown</h3>
            <div class="h-72">
              <Pie :data="expensePieChartData.data" :options="expensePieChartData.options" />
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div v-if="revenueBarChartData" class="mt-6">
            <h3 class="text-lg font-medium text-gray-900 mb-3">Revenue by Product</h3>
            <div class="h-72">
              <Bar :data="revenueBarChartData.data" :options="revenueBarChartData.options" />
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div v-if="profitVsExpenseBarChartData" class="mt-6">
            <h3 class="text-lg font-medium text-gray-900 mb-3">Revenue vs Expenses</h3>
            <div class="h-72">
              <Bar :data="profitVsExpenseBarChartData.data" :options="profitVsExpenseBarChartData.options" />
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div v-if="cowAvgDailyLineData" class="bg-white rounded-lg shadow p-6">
          ...
          <div class="h-72">
            <Line :data="cowAvgDailyLineData.data" :options="cowAvgDailyLineData.options" />
          </div>
        </div>
        <div
...
export default {
  ...
  computed: {
    ...
    cowAvgDailyLineData() {
      ...
      const values = this.cowProductionReport.map((c) => Number(c.averageDaily || 0));
      return {
        data: {
          labels,
          datasets: [
