<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <OverdueCustomers
      :overdue-customers="overDueCustomers"
      @view-all-customers="handleViewAllCustomers"
...
export default {
  ...
  methods: {
    ...
    ...mapActions("customer", ["getOverDueCustomers"]),
    ...
    handleViewAllCustomers() {
      // Navigate to customers page or open customer modal
      this.$router.push("/customers");
    },

    handleSendReminders() {
      // Implement send reminders functionality
      // This could open a modal or navigate to a reminders page
      console.log("Send reminders to overdue customers");
  ...
  async mounted() {
    ...
    await this.getOverDueCustomers();
